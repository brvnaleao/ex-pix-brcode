defmodule ExPixBRCode.Payments.Models.DynamicImmediatePixPaymentTest do
  ...
  describe "changeset/2" do
    ...
    test "successfully validates a proper payload  with infoAddicionais as empty strings" do
      payload = %{
        "calendario" => %{
          "apresentacao" => "2020-11-25T18:06:39Z",
          "criacao" => "2020-11-13T13:46:43Z",
    ...
    for modalidadeAgente <- ["AGTEC", "AGTOT", "AGPSS"] do
      test "successfully validates a proper withdrawal payload without optional fields and 'saque.modalidadeAgente' #{modalidadeAgente} " do
        payload = %{
          "calendario" => %{
            "apresentacao" => "2020-11-25T18:06:39Z",
            "criacao" => "2020-11-13T13:46:43Z",
